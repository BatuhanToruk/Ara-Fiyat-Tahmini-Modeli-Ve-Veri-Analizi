...
Bu rapor, ikinci el araç fiyatlarını tahmin etmek amacıyla gerçekleştirilen veri analizi ve makine öğrenimi modelleme süreçlerinin tüm detaylarını, bulgularını ve sonuçlarını içermektedir. Amacım, en doğru ve genellenebilir tahminleri yapabilen bir model geliştirmektir.Buu çalışmada kaggle üzerinden "https://www.kaggle.com/datasets/austinreese/craigslist-carstrucks-data/data" linkte belirtilen Used Cars Dataset veri seti baz alınmıştır
...
Test RMSE:  
3,520.48∗∗∗OverfittingGap∗∗:0.0072(Overfittingyok)∗∗∗EnÖnemliÖzellikler∗∗:‘pricepermile‘(∗∗∗Yorum∗∗:DoğrusalmodelleregöreDRAMATİKBİRİYİLEŞME!HemREMAX′inR²(≥0.90)hemdeRMSE(≤ 25K) hedeflerini fazlasıyla karşıladı ve minimal overfitting gösterdi.
